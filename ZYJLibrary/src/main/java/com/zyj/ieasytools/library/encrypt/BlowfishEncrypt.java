...
public class BlowfishEncrypt extends BaseEncrypt {
    ...
    private static class BlowfishCBC extends BlowfishECB {
        ...
        private void setCBCIV(long lNewCBCIV) {
            m_lCBCIV = lNewCBCIV;
        }

        private void setCBCIV(byte newCBCIV[]) {
        ...
        private BlowfishCBC(byte bfkey[]) {
            super(bfkey);
            setCBCIV(0L);
        }

        private BlowfishCBC(byte bfkey[], long lInitCBCIV) {
            super(bfkey);
            setCBCIV(lInitCBCIV);
        }

        private BlowfishCBC(byte bfkey[], byte initCBCIV[]) {
            super(bfkey);
            setCBCIV(initCBCIV);
        }
    }
    ...
    private static class BlowfishECB {
        ...
        private BlowfishECB(byte bfkey[]) {
            m_pbox = new int[18];
    ...
    private String decryptString(String sCipherText) {
